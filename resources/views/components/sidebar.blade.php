        ...
        <ul class="space-y-2 font-medium border-t border-default pt-4 mt-4">
            ...
            <li>
                <a href="/admin/permission"
                    ...
                    @if ($permissionPendingCount > 0)
                        <span
                            class="inline-flex items-center justify-center min-w-5 h-5 px-1.5 ms-2 text-2xs font-bold text-red-600 bg-red-100 border border-red-200 rounded-full animate-pulse">
        ...
        <ul class="space-y-2 font-medium border-t border-default pt-4 mt-4">
            ...
            <li>
                <form method="POST" action="{{ route('admin.logout') }}">
                    @csrf
                    <button type="submit"
                        class="group flex w-full items-center px-3 py-2 text-sm font-medium text-red-600 rounded-lg hover:bg-red-500 transition-all duration-200">
