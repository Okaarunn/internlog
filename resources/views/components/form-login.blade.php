<div class="min-h-screen flex items-center justify-center px-4 py-8 " style="font-family: 'Inter', sans-serif;">
    <div
        ...
        <div class="hidden lg:flex relative w-120 shrink-0 flex-col justify-end p-8">
            <img src="https://images.unsplash.com/photo-1748346918817-0b1b6b2f9bab?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1080"
        ...
        <div class="flex-1 p-8 sm:p-10 flex flex-col justify-center">
            ...
            <form method="POST" action="{{ route('login.submit') }}" class="space-y-5 relative">
                @csrf
